(function () {
    ...
    function debug_log_real(message) { console.log(message); }

    function debug_log_real_OLD(message) {
        var html, entry;
        if (!debug_win) {
            debug_win = window.open("about:blank", "3333-Debug",
                "width=300,height=300,scrollbars=1,resizable=1");
            html = "<html><head><title>3333 Debug</title></head><body>" +
